...
?>
	...
	<script>
		jQuery(document).ready(function() {
			...
			jQuery(".elementor-widget.smaller-header .elementor-image-box-title").fitText(1.4);
			jQuery(".elementor-widget.smaller-description .elementor-image-box-description").fitText(1.8);
		})
	</script>
<?php wp_footer(); ?>
