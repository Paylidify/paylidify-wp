...
?>
	...
	<script>
		jQuery(document).ready(function() {
			...
			jQuery(".custom-image-circle.smaller-header .elementor-image-box-title").fitText(1.3);
			jQuery(".custom-image-circle.smaller-description .elementor-image-box-description").fitText(1.7);
		})
	</script>
<?php wp_footer(); ?>
