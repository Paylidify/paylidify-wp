...
class Custom_Testimonial_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Paylidify Testimonial', 'elementor' );
	}
				...
				<div class="elementor-testimonial-meta-inner">
					<?php if ( $has_image ) : ?>
						<div class="elementor-testimonial-image">
							<?php
							$image_html = \Elementor\Group_Control_Image_Size::get_attachment_image_html( $settings, 'testimonial_image' );
							if ( ! empty( $settings['link']['url'] ) ) :
